...
public class AxinPlanetGenerator extends PlanetGenerator{
    ...
    Block[][] arr =
            {
                    {Blocks.cryofluid, Blocks.darksand, Blocks.darksand, Blocks.darksand, Blocks.darksand, Blocks.sand, Blocks.sand, Blocks.sand, Blocks.sand, Blocks.carbonStone, Blocks.carbonStone},
                    {Blocks.cryofluid, Blocks.darksand, Blocks.darksand, Blocks.sand, Blocks.sand, Blocks.sand, Blocks.sand, Blocks.sand, Blocks.carbonStone, Blocks.carbonStone, Blocks.carbonStone},
                    {Blocks.cryofluid, Blocks.darksand, Blocks.sand, Blocks.sand, Blocks.sand, Blocks.sand, Blocks.sand, Blocks.carbonStone, Blocks.carbonStone, Blocks.carbonStone},
                    {Blocks.cryofluid, Blocks.sand, Blocks.sand, Blocks.carbonStone, Blocks.carbonStone, Blocks.carbonStone, Blocks.snow, Blocks.iceSnow, Blocks.ice},
                    {Blocks.cryofluid, Blocks.cryofluid, Blocks.sand, Blocks.sand, Blocks.sand, Blocks.basalt, Blocks.snow, Blocks.snow, Blocks.snow, Blocks.snow, Blocks.ice},
                    {Blocks.cryofluid, Blocks.cryofluid, Blocks.sand, Blocks.sand, Blocks.sand, Blocks.iceSnow, Blocks.snow, Blocks.snow, Blocks.ice, Blocks.snow, Blocks.ice},
                    {Blocks.cryofluid,  Blocks.sand, Blocks.sand, Blocks.snow, Blocks.crystallineStone, Blocks.crystallineStone, Blocks.crystallineStone, Blocks.ice, Blocks.snow, Blocks.ice},
                    {Blocks.darksand, Blocks.darksand, Blocks.basalt, Blocks.basalt, Blocks.basalt, Blocks.ice, Blocks.snow, Blocks.ice, Blocks.ice},
                    {Blocks.darksand, Blocks.darksand, Blocks.darksand, Blocks.snow, Blocks.basalt, Blocks.basalt, Blocks.ice, Blocks.snow, Blocks.ice, Blocks.ice},
                    {Blocks.darksand, Blocks.darksand, Blocks.ice, Blocks.ice, Blocks.snow, Blocks.snow, Blocks.snow, Blocks.snow, Blocks.ice, Blocks.ice, Blocks.ice},
                    {Blocks.darksand, Blocks.ice, Blocks.ice, Blocks.snow, Blocks.snow, Blocks.ice, Blocks.ice, Blocks.ice, Blocks.ice},
                    {Blocks.darksand, Blocks.iceSnow, Blocks.snow, Blocks.ice, Blocks.ice, Blocks.ice, Blocks.ice, Blocks.ice},
                    { Blocks.darksand, Blocks.snow, Blocks.ice, Blocks.iceSnow, Blocks.snow, Blocks.snow, Blocks.snow, Blocks.ice, Blocks.ice, Blocks.ice, Blocks.ice, Blocks.ice}
            };

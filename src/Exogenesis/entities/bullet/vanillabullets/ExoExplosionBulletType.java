...
public class ExoExplosionBulletType extends ExplosionBulletType implements ExoBullet {
    ...
    public void hitEntity(Bullet b, Hitboxc entity, float health) {
        ...
        if (entity instanceof Unit unit) {
            float mul = 1f;
            if (unit.type instanceof ExoUnitType exoType)
                mul = exoType.multipliers[Structs.indexOf(DamageType.values(), damageType)];
